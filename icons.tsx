...
export const BotIcon: React.FC<IconProps> = ({ className }) => (
  <svg 
    ...
    aria-hidden="true"
  >
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM8 11.5c0-.83.67-1.5 1.5-1.5S11 10.67 11 11.5s-.67 1.5-1.5 1.5S8 12.33 8 11.5zm5 0c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5S13 12.33 13 11.5zm3.5 4H7.5c-.28 0-.5.22-.5.5s.22.5.5.5h8c.28 0 .5-.22-.5-.5s-.22-.5-.5-.5z"/>
  </svg>
);
...
export const EnterKeyIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
